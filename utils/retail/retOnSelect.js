...
const checkOnSelect = (on_select, ErrorObj) => {
  let onSlctObj = ErrorObj;
  try {
    ...
    //     console.log("Error not expected in this select call as per Business Flow")
    //   }
    // } catch (error) {
    //   console.log(
        ...
        if (
          ...
          if (
            ...
            (itemsIdList[item["@ondc/org/item_id"]] >
              item["@ondc/org/item_quantity"].count 
              //&&
              // on_select_error && // Check with Sandeep, why checking on_select error here
